...
public class UpdateUserInfoTest extends AbstractCommonOperations implements ApiTestWithPayload {

	private static final String API_URL = "/user";

	private static final String RESOURCE_FOLDER = "/user/updateuserinfotest/";
